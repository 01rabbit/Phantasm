# Track Package: Field-Operations

## Positioning

Use this framing for audiences prioritizing constrained-device deployment, operational resilience, and inspection-pressure safety behavior.

## Title and Subtitle

Title:
`Phasmid: Field-Ready Coercion-Aware Storage for Constrained Devices`

Subtitle:
`Local-only disclosure control for high-risk field operations`
...
- political framing as primary message
- anti-state narratives
- anti-forensic headline language
