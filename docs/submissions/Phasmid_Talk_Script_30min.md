...
**EN:** "A quick note on where I come from: like a lot of people in this room, I started in uniform — a former Japan Ground Self-Defense Force officer, a Second Lieutenant, in a cyber unit. My work since has mostly been offensive — and offensive work is really about the **person, not just the algorithm**; the weakest link is human. Phasmid points that lesson the other way: **it doesn't protect the key, it protects the person holding it.** Day-to-day I'm a senior engineer at **GMO Cybersecurity by Ierae, Inc.** in Tokyo — security research and open-source tools, pen tester, CISSP — you may have seen the Azazel system or the PAKURI family at Black Hat Arsenal, BSides, SecTor, CODE BLUE. Find me at **01rabbit** on GitHub."
